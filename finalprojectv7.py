...
def study(flashcard_set_name):
    ...
    if not os.path.isfile(flashcard_set):  # Checks if the flashcard set exists
        messagebox.showerror("Error", f"The flashcard set '{flashcard_set_name}' does not exist.")  # Shows an error
        return
